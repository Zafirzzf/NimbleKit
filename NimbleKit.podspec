#
#  Be sure to run `pod spec lint NimbleKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Zaifrzzf" => "Zaifrzzf@163.com" }
  # Or just: s.author    = "zhouzf"
  # s.authors            = { "zhouzf" => "zhouzf@mixotc.com" }
  ...
  s.source       = { :git => "https://github.com/Zafirzzf/NimbleKit.git", :tag => "1.0" }
